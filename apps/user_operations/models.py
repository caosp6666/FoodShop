...
class UserLeavingMessage(models.Model):
    ...
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间", help_text="留言时间")
...
class UserAddress(models.Model):
    ...
    district = models.CharField(max_length=100, default="", verbose_name="区域", help_text="区")
    ...
    signer_mobile = models.CharField(max_length=11, default="", verbose_name="电话", help_text="手机")
